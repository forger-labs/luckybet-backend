...
export const LuckyBetGameItemResponseSchema = apiResponseSchema(LuckyBetGameItemSchema);
export const LuckyBetGameItemResponsePaginatedSchema =
	paginatedResponseSchema(LuckyBetGameItemSchema);
