...
export class CoreSchema1790308726466 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "players" ADD CONSTRAINT "FK_f7a2eabf8f2f018cf9f82364f03" FOREIGN KEY ("level_id") REFERENCES "levels"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "players" ADD CONSTRAINT "FK_42530bbf46c4b64a5921dbc2047" FOREIGN KEY ("room_id") REFERENCES "bonus_rooms"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "levels" ADD CONSTRAINT "FK_f19a21470ac8919bef8a01fe9b2" FOREIGN KEY ("room_id") REFERENCES "bonus_rooms"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "level_rewards" ADD CONSTRAINT "FK_a0a4a09e16877933230fbf55dff" FOREIGN KEY ("player_id") REFERENCES "players"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "level_rewards" ADD CONSTRAINT "FK_d9e5b5f1f07423d2c0433053f1c" FOREIGN KEY ("level_id") REFERENCES "levels"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "level_rewards" ADD CONSTRAINT "FK_18f04e9451f4dd5215a636f9808" FOREIGN KEY ("room_id") REFERENCES "bonus_rooms"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "level_rewards" ADD CONSTRAINT "FK_6255f94308085eb8150c8adff3e" FOREIGN KEY ("resolved_by_admin_id") REFERENCES "admin_users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "missions" ADD CONSTRAINT "FK_1872998c9789f58e08fd31a6229" FOREIGN KEY ("room_id") REFERENCES "bonus_rooms"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "user_mission_chests" ADD CONSTRAINT "FK_a53dbcaa81253c1d3768aac18a3" FOREIGN KEY ("room_id") REFERENCES "bonus_rooms"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "user_mission_chests" ADD CONSTRAINT "FK_54567b85b81256f859784f18c22" FOREIGN KEY ("chest_id") REFERENCES "mission_chests"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "user_mission_chests" ADD CONSTRAINT "FK_a3e77110b7f7d215ff28e452e0b" FOREIGN KEY ("resolved_by_admin_id") REFERENCES "admin_users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "mission_rewards" ADD CONSTRAINT "FK_9f156e9620446ef71aed714f023" FOREIGN KEY ("room_id") REFERENCES "bonus_rooms"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "mission_rewards" ADD CONSTRAINT "FK_926142e94dc3b2ff712b2f4fe19" FOREIGN KEY ("user_mission_id") REFERENCES "user_missions"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
			`ALTER TABLE "mission_rewards" ADD CONSTRAINT "FK_a219a5602a7c533b608ae070b31" FOREIGN KEY ("resolved_by_admin_id") REFERENCES "admin_users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
		);
	}

	public async down(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`ALTER TABLE "mission_rewards" DROP CONSTRAINT "FK_a219a5602a7c533b608ae070b31"`,
		);
		await queryRunner.query(
			`ALTER TABLE "mission_rewards" DROP CONSTRAINT "FK_926142e94dc3b2ff712b2f4fe19"`,
		);
		await queryRunner.query(
			`ALTER TABLE "mission_rewards" DROP CONSTRAINT "FK_9f156e9620446ef71aed714f023"`,
		);
		await queryRunner.query(
			`ALTER TABLE "user_mission_chests" DROP CONSTRAINT "FK_a3e77110b7f7d215ff28e452e0b"`,
		);
		await queryRunner.query(
			`ALTER TABLE "user_mission_chests" DROP CONSTRAINT "FK_54567b85b81256f859784f18c22"`,
		);
		await queryRunner.query(
			`ALTER TABLE "user_mission_chests" DROP CONSTRAINT "FK_a53dbcaa81253c1d3768aac18a3"`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "missions" DROP CONSTRAINT "FK_1872998c9789f58e08fd31a6229"`,
		);
		await queryRunner.query(
			`ALTER TABLE "level_rewards" DROP CONSTRAINT "FK_6255f94308085eb8150c8adff3e"`,
		);
		await queryRunner.query(
			`ALTER TABLE "level_rewards" DROP CONSTRAINT "FK_18f04e9451f4dd5215a636f9808"`,
		);
		await queryRunner.query(
			`ALTER TABLE "level_rewards" DROP CONSTRAINT "FK_d9e5b5f1f07423d2c0433053f1c"`,
		);
		await queryRunner.query(
			`ALTER TABLE "level_rewards" DROP CONSTRAINT "FK_a0a4a09e16877933230fbf55dff"`,
		);
		await queryRunner.query(
			`ALTER TABLE "levels" DROP CONSTRAINT "FK_f19a21470ac8919bef8a01fe9b2"`,
		);
		await queryRunner.query(
			`ALTER TABLE "players" DROP CONSTRAINT "FK_42530bbf46c4b64a5921dbc2047"`,
		);
		await queryRunner.query(
			`ALTER TABLE "players" DROP CONSTRAINT "FK_f7a2eabf8f2f018cf9f82364f03"`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "mission_chests" DROP CONSTRAINT "FK_051b5892eb94e4268a5943fe3c6"`,
		);
