...
export const levelRewardFilterSchema = z.object({
  levelId: z.coerce
    ...
    .positive()
    .optional()
    .describe('Filtrar por nivel'),
  status: z
    .enum(RewardStatus)
    .optional()
    .describe('Filtrar por estado del reclamo'),
  orderBy: z
...
export const resolveUncertainLevelClaimSchema = z.object({
  ...
  adminNotes: z
    .string()
    .optional()
    .describe('Notas u observaciones del administrador'),
});
...
export const SingleLevelRewardResponseSchema = apiResponseSchema(
  levelRewardBasicSchema,
);
export const LevelRewardListResponseSchema = paginatedResponseSchema(
  levelRewardBasicSchema,
);
...
export class LevelRewardFilterDto extends createZodDto(
  levelRewardFilterSchema,
) {}
